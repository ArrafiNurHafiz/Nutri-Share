    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          ...
          <h2 className="text-xl font-bold mb-1 text-center">Write a Review</h2>
          <p className="text-sm text-gray-500 mb-6 text-center">
            How was your experience receiving <b>{donation.food_name}</b> from{" "}
            <b>{donation.donor_name}</b>?
          </p>
          ...
          >
            ...
            <textarea
              placeholder="Share your experience, or thanks to the food heroes... (Optional)"
              value={comment}
            ...
            <button
              disabled={loading}
              type="submit"
              className="w-full bg-[#1565C0] text-white font-bold py-3 rounded-xl hover:bg-opacity-90 transition-all shadow-md active:scale-95 disabled:opacity-50 disabled:active:scale-100"
            >
